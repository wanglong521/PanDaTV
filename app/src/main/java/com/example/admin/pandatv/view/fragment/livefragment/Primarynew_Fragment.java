 ...
 */
//这是小媛荣的代码
public class Primarynew_Fragment extends BaseFragment implements PrimaryView {

    private PtrFrameLayout ptrFrameLayout;
    private ListView other_listview;
    private int a=1;
    private List<PrimarynewBean.VideoBean> primarylist=new ArrayList<PrimarynewBean.VideoBean>();
    private PrimmaryAdapter adapter;
    private IPresenterImplPrimary iPresenterImplPrimary;
    private String vid;
    private String uri;
    ...
    protected void initView(View view) {
        ...
        adapter = new PrimmaryAdapter(getActivity(),primarylist);

        other_listview.setAdapter(adapter);
    }

    @Override
    public void OnSucceed(PrimarynewBean succed) {

        List<PrimarynewBean.VideoBean> video = succed.getVideo();

        primarylist.addAll(video);
