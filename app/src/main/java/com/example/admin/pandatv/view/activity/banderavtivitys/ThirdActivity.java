...
public class ThirdActivity extends BaseActivity implements MediaPlayer.OnPreparedListener {
    ...
    protected void initView() {
        ...
        vitamio_viedoview = (VideoView) findViewById(R.id.vitamio_viedoviewthird);
