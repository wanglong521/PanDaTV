...
public class PThingAdapter extends BaseAdapter{
    private Context context;
    private List<PandaThingBean.VideoBean> list;
    private ViewHolder viewHolder;

    public PThingAdapter(Context context, List<PandaThingBean.VideoBean> list) {
