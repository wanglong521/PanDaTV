...
public class PandaTOPAdapter extends BaseAdapter{
    private Context context;
    private List<PandaTOPBean.VideoBean> list;
    private ViewHolder viewHolder;

    public PandaTOPAdapter(Context context, List<PandaTOPBean.VideoBean> list) {
